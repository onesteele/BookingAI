...
// Money bag icon for Profit Insider brand
const LOGO_SVG = `<svg viewBox="0 0 24 24" fill="currentColor"><path d="M12 2c-1.1 0-2 .4-2.7 1L8 4H6.5A2.5 2.5 0 0 0 4 6.5v.5C4 8.3 4.7 9.4 5.8 10A8 8 0 0 0 4 16c0 4 3.6 7 8 7s8-3 8-7a8 8 0 0 0-1.8-5.1C19.3 9.4 20 8.3 20 7v-.5A2.5 2.5 0 0 0 17.5 4H16l-1.3-1C14 2.4 13.1 2 12 2zm0 2c.6 0 1 .2 1.4.5L14.6 6H9.4l1.2-.5C11 2.2 11.4 4 12 4zM6.5 6H18a.5.5 0 0 1 .5.5V7a2 2 0 0 1-2 2h-9a2 2 0 0 1-2-2v-.5A.5.5 0 0 1 6.5 6zM12 11a6 6 0 1 1 0 12A6 6 0 0 1 12 11zm1 2h-2v1.3c-.8.3-1.4 1-1.4 1.9 0 1.2.9 1.9 2.2 2.2.7.2 1 .4 1 .7s-.3.6-1 .6c-.6 0-1-.3-1-.7H9.4c0 1 .7 1.8 1.6 2v1.1h2V21c.9-.2 1.6-1 1.6-2 0-1.2-.9-1.9-2.2-2.2-.7-.2-1-.4-1-.7s.3-.6.9-.6.9.3.9.7H15c0-1-.7-1.8-1.6-2V13z"/></svg>`
